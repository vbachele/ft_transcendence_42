...
import { H1Title, NormalText, Subtitle } from 'components/Text';
...
const Popup: React.FC<Props> = (props) => {
  ...
  return (
    <>
	  ...
	  width={"393px"}
		...
		footer={[
			<div className="popup__logout_button">
				<Button className="no-style-button" key="cancel" color={'black'} onClick={() => setModal2Open(false)}>
				{
					<div style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      >
		<div style={{ display: 'flex', justifyContent: 'center'}}>
		<Subtitle display={'true'} color='black'>Already tired of playing?</Subtitle>
		</div>
